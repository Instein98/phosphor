...
public class ReflectionHidingMV extends MethodVisitor implements Opcodes {
    ...
    public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean isInterface) {
        ...
        if ((disable || className.equals("java/io/ObjectOutputStream") || className.equals("java/io/ObjectInputStream")) && owner.equals("java/lang/Class") && !owner.equals(className) && name.startsWith("isInstance")) {
            ...
            // In Java 9+, String concatenation is done via the StringConcatFactory class, which
            // relies on some classes generated by ClassSpecializer class. Some of these classes
            // are pre-gernated and some of them are generated at runtime. The following code
            // tries to instrument those dynamically generated classes.
            else if (this.className.equals("java/lang/invoke/ClassSpecializer$Factory")
                && this.methodName.equals("generateConcreteSpeciesCode")
                && opcode == Opcodes.INVOKEVIRTUAL
                && owner.equals(this.className)
                && name.equals("generateConcreteSpeciesCodeFile")
                && desc.equals("(Ljava/lang/String;Ljava/lang/invoke/ClassSpecializer$SpeciesData;Ledu/columbia/cs/psl/phosphor/runtime/PhosphorStackFrame;)[B")){
                INSTRUMENT_CLASS_BYTES.delegateVisit(mv);
            }
        }
    }
